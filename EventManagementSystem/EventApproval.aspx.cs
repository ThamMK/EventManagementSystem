...
namespace EventManagementSystem
{
    public partial class EventApproval : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                Event event1 = new Event("TARUC Relax", "12/05/2017", "12/05/2017", "10.00am", "5.00pm", "Bagunan Tan Siew Sin", "FREE", "Seminar", "", "Tham Ming Keat", "thammingkeat96@gmail.com", "~/Images/Event/event1.PNG", "Disapproved");
        ...
        public void Edit_ItemCreated(Object Sender, RepeaterItemEventArgs e) 
        {
                ...
                try
                {
                    ...
                    {
                        case 0:
                            lblStatus.Attributes.CssStyle.Add("background-color", "#DD6B55");
                            lblStatus.Attributes.CssStyle.Add("border", "0.5px solid #DD6B55");
                            break;
                        case 1:
                            lblStatus.Attributes.CssStyle.Add("background-color", "#A5DC86");
                            lblStatus.Attributes.CssStyle.Add("border", "0.5px solid #A5DC86");
                            break;
                        case 2:
                            lblStatus.Attributes.CssStyle.Add("background-color", "deepskyblue");
                            lblStatus.Attributes.CssStyle.Add("border", "0.5px solid deepskyblue");
                            break;
                    }
                }catch
                {
